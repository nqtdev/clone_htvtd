...
import dataShowDevicePrints from 'data/dataDevicePrints'

const ShowDevicePrint = () => {
  return (
    <div className='mt-10'>
      <div className='bg-slate-500 rounded-lg'>
        <p className='p-3 font-roboto text-white'>Máy In</p>
      </div>
      <div className='grid grid-cols-5 gap-4 mt-4'>
        {dataShowDevicePrints.map(device => (
          <Card
            key={device.id}
            hoverable
            style={{
...
export default ShowDevicePrint
